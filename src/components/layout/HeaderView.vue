    ...
    <div class="w-[90vw] md:w-[70vw] xl:w-[60vw] mx-auto duration-300">
      <div class="flex justify-between items-center py-4">
        ...
        <ul class="hidden md:flex items-center gap-5">
          ...
          <li>
            <a class="text-3h hover:border-primary hover:bg-primary hover:text-white rounded-[20px] px-3 py-1" href="https://drive.google.com/file/d/1vin5wyVK3ctH2mBcOc6lxamssCIOtoZU/view">下載履歷</a>
          </li>
          <!-- <li class="h-[20px] overflow-hidden">
      ...
      <div data-aos="fade-left" v-if="isMenu" class="fixed top-0 left-0 w-full h-full bg-white">
        ...
        <ul class="flex flex-col h-full justify-center px-4">
          ...
          <li><a class="w-full text-6 py-3 flex items-end font-bold ps-2" href="https://drive.google.com/file/d/1vin5wyVK3ctH2mBcOc6lxamssCIOtoZU/view">下載履歷<span class="block text-4 ms-2">Resume</span></a></li>
