    ...
    <div class="w-[90vw] md:w-[70vw] xl:w-[60vw] mx-auto duration-300">
      <div class="flex justify-between items-center py-4">
        ...
        <ul class="hidden md:flex items-center gap-5">
          ...
          <li>
            <a @click="isMenu = false" class="text-3h hover:border-primary hover:bg-primary hover:text-white rounded-[20px] px-3 py-1" href="https://github.com/Tami1118/tami-personal/public/%E9%99%B3%E5%A7%BF%E5%AC%91_%E5%89%8D%E7%AB%AF%E5%B7%A5%E7%A8%8B%E5%B8%AB.pdf" target="_blank">下載履歷</a>
          </li>
          <!-- <li class="h-[20px] overflow-hidden">
      ...
      <div data-aos="fade-left" v-if="isMenu" class="fixed top-0 left-0 w-full h-full bg-white">
        ...
        <ul class="flex flex-col h-full justify-center px-4">
          ...
          <li><a class="w-full text-6 py-3 flex items-end font-bold ps-2" @click="isMenu = false" href="https://github.com/Tami1118/tami-personal/public/%E9%99%B3%E5%A7%BF%E5%AC%91_%E5%89%8D%E7%AB%AF%E5%B7%A5%E7%A8%8B%E5%B8%AB.pdf" target="_blank">下載履歷<span class="block text-4 ms-2">Resume</span></a></li>
